...
urlpatterns = [
    ...
    path('auth/check-device-approval/', views.check_device_approval_ajax_view, name='check_device_approval_ajax'),
    ...
    path('auth/email-preview/email-change-otp/', views.email_preview_email_change_otp_view, name='preview_email_change_otp'),
    path('auth/email-preview/email-change-confirmation/', views.email_preview_email_change_confirmation_view, name='preview_email_change_confirmation'),
