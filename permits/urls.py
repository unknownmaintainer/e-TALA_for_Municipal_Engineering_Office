...
urlpatterns = [
    ...
    path('auth/device-pending/', views.device_pending_approval_view, name='device_pending_approval'),
    path('auth/device-status-check/', views.check_device_approval_ajax, name='check_device_approval_ajax'),
    path('auth/approve-device/', views.approve_device_view, name='approve_device'),
    path('auth/reject-device/', views.reject_device_view, name='reject_device'),
