...
## Focus Areas
-   **Cloud Governance & Landing Zones**: Designing organizational structures, account vending machines, and guardrails.
...
-   **Migration Strategy**: Planning and executing large-scale migrations to the cloud.
...
-   **Target Architecture Diagrams**: Detailed diagrams showing containers, components, and context.
-   **Infrastructure as Code (IaC) Strategy**: A plan for structuring Terraform modules, managing state, and implementing CI/CD.
